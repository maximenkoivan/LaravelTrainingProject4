...
@section('content')
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="{{$linkCreate}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company" id="simpleinput" class="form-control" value="{{old('company')}}">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" name="phone_number" id="simpleinput" class="form-control" value="{{old('phone_number')}}">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" name="residence_address" id="simpleinput" class="form-control" value="{{old('residence_address')}}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="vk" class="form-control border-left-0 bg-transparent pl-0" value="{{old('vk')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="telegram" class="form-control border-left-0 bg-transparent pl-0" {{old('telegram')}}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="instagram" class="form-control border-left-0 bg-transparent pl-0" value="{{old('instagram')}}">
                                        </div>
                                    </div>
