                ...
                <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                    <div class="d-flex align-items-center container p-0">
                        <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                            <a href="{{$linkHomePage}}" class="page-logo-link press-scale-down d-flex align-items-center">
                        ...
                        <a href="{{$linkLogin}}" class="btn-link text-white ml-auto ml-sm-0">
                            Войти
                        </a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    @endif
                                    <form id="js-login" action="{{$linkReg}}" method="post">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Email</label>
                                            <input type="email" name="email" id="emailverify" class="form-control" placeholder="Эл. адрес" value="{{old('email')}}">
